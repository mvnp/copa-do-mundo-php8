            ...
            <div class="row">
                <div class="col-12 col-md-3">
                    ...
                    <div class="card card-primary">
                        ...
                        <form id="quickFormUser" action="{{ url('users/update/'.$obj['upd']->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Endereço de e-mail</label>
                                    <input value="{{ $obj['upd']->email }}" type="email" id="email" name="email" class="form-control @error('email') is-invalid @enderror" placeholder="Insira e-mail ..." required />
                                    @error('email')
                                        <div class="invalid-feedback alerta">
                                            {{$message}}
                                        </div>
                                ...
                                <div class="form-group card-footer botao">
                                    <div class="col-6 md-6 voltar">
                                        <button type="button" class="btn btn-primary voltar">
                                            <a href="javascript:retornar();">Voltar</a>
                                        </button>
                                    </div>
                                    <div class="col-6 md-6 atualizar">
